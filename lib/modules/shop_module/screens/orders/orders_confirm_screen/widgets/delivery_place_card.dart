...
class DeliveryAdressCard extends StatefulWidget {
  const DeliveryAdressCard(
      ...
      required this.userInformationAdress});
  final Function(String adress) updateAdress;
  final GlobalKey<FormState> formKey;
  final String userInformationAdress;
      ...
      widget: Column(
        children: [
          ...
          RadioListTile(
            ...
            subtitle: Text(widget.userInformationAdress),
            groupValue: _deliveryPlaceType,
            onChanged: (value) {
              setState(() {
                _deliveryPlaceType = value as DeliveryPlaceType;
              });
              widget.updateAdress(widget.userInformationAdress);
            },
